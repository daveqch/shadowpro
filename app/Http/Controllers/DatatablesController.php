...
//                {
                    ...
                    {
                        $btn .= '<a href="'.route('roles.edit',['role' => $row->id]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                    }
//                }
...
//                {
                    if (Auth::user()->hasPermissionTo('role-delete'))
                    {
                        ...
                        $btn .= '<a href="#" data-href="'.route('roles.customDestroy',['id' => $row->id]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                    }
//                }
                return $btn;
            })
...
//                {
                    $btn .= '<a href="'.route('users.edit',['user' => $row->id]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
//                }
                $deleteUser = trans('Are You Sure You Want To Delete This User');
//                if (Auth::user()->hasPermissionTo('user-delete')) {
                    $btn .= '<a href="#" data-href="'.route('users.destroy',['id' => $row->id]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
//                }
                return $btn;
    ...
    public function companiesList()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function($row){
                $btn='';
                $btn .= '<a href="'.route('company.edit',['id' => Crypt::encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                $btn .= '<a href="#" data-href="'.route('company.destroy',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                return $btn;
            })
        ...
        return datatables()
            ...
            ->addColumn('action', function($row)
            {
                ...
                // {
                    ...
                    $btn .= '<a href="'.route('currency.edit',['currency' => Crypt::encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';

                // }
                // if (Auth::user()->hasPermissionTo('loan-delete'))
                // {

                    $btn .= '<a href="#" data-href="'.route('currency.delete',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
        ...
        return datatables()
            ...
            ->addColumn('action', function($row)
            {
                ...
                // {
                    ...
                    $btn .= '<a href="'.route('category.edit',['category' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                // }
                // if (Auth::user()->hasPermissionTo('loan-delete'))
                // {
                    $btn .= '<a href="#" data-href="'.route('category.delete',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                // }
                return $btn;
            })
            ->addColumn('name', function ($row)
        ...
        return datatables()
            ...
            ->addColumn('action', function($row)
            {
                ...
                // {
                    ...
                    $btn .= '<a href="'.route('tax.edit',['tax' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                // }
                // if (Auth::user()->hasPermissionTo('loan-delete'))
                // {
                    $btn .= '<a href="#" data-href="'.route('tax.delete',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                // }
                return $btn;
            })
    ...
    public function AccountList()
    {
        ...
        return datatables()
            ...
            {
                $btn = '';
                    $btn .= '<a href="'.route('account.edit',['account' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                    $btn .= '<a href="#" data-href="'.route('account.delete',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                return $btn;
            })
            ->addColumn('name', function ($row)
            {
    ...
    public function TransfersList()
    {
        ...
        return datatables()
            ...
            {
                $btn = '';
                    $btn .= '<a href="'.route('transfers.edit',['transfer' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                    $btn .= '<a href="#" data-href="'.route('transfers.delete',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                return $btn;
            })
    ...
    public function CustomerList()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function($row)
            {
                ...
                // if (Auth::user()->hasPermissionTo('loan-edit'))
                // {
                    $btn .= '<a href="'.route('customer.edit',['customer' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp';
                // }
                // if (Auth::user()->hasPermissionTo('loan-delete'))
                // {
                    $btn .= '<a href="#" data-href="'.route('customer.delete',['id' => encrypt($row->id)]).'" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>';
                // }
                return $btn;
            })
            ->addColumn('name', function ($row)
