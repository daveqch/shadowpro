                ...
                <table id="laravel_datatable" class="table table-striped compact table-width">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if(isset($invoice->customer->name) && !empty($invoice->customer->name))
                            ...
                            <td>
                                <a href="{{ route('invoice.show', $invoice) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="View"><span class="mdi mdi-eye ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                <a href="{{ route('invoice.edit', $invoice) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                <a href="#" data-href="{{ route('invoice.destroy', $invoice) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
