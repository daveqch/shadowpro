                    ...
                    <tbody>
                        @foreach ($vendors as $vendor)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('vendor.show', $vendor->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Show')"><span class="mdi mdi-eye ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @can('vendor-update')
                                        <a href="{{ route('vendor.edit', $vendor->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('vendor-update')
                                        <a href="#" data-href="{{ route('vendor.destroy', $vendor->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
