        ...
        <div class="panel panel-default">
            ...
            <div class="card-header">
                ...
                <div class="card-body wizard-content  ">
                     <form  class="form-material form-horizontal validation-wizard wizard-circle" action="{{ route('employee.store') }}" id="employee_create_form" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Step 1 -->
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group ">
                                    ...
                                    <div class="input-group mb-3 ">
                                        ...
                                        <input id="full_name" placeholder="{{__('Type Your Full Name')}}" class="form-control @if($errors->has('full_name')) is-invalid @endif" name="full_name" type="text" value="{{ old('full_name') }}" required>
                                ...
                                <div class="col-sm-6 form-group ">
                                        ...
                                        <input id="phone" placeholder="{{__('Type Your Phone Number')}}" class="form-control @if($errors->has('phone')) is-invalid @endif" name="phone" type="text" value="{{ old('phone') }}" required>
                                        @error('phone')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control datepicker ambitious-form-loading @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ old('birth_date') }}" id="birth_date" type="text" required>
                                        @error('birth_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <textarea id="present_address" class="form-control @error('present_address') is-invalid @enderror" name="present_address" rows="5" required>{{ old('present_address') }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <textarea id="permanent_address" class="form-control @error('permanent_address') is-invalid @enderror" name="permanent_address" rows="5" required>{{ old('permanent_address') }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea id="note" rows="3" class="form-control @error('note') is-invalid @enderror" name="note" rows="5">{{ old('note') }}</textarea>
                                            @error('note')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('e_id') is-invalid @enderror" name="e_id" value="{{ old('e_id') }}" id="e_id" type="text"  placeholder="{{ __('Type Employe ID') }}" required >
                                            @error('e_id')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control datepicker ambitious-form-loading @error('joining_date') is-invalid @enderror" name="joining_date" value="{{ old('joining_date') }}" id="joining_date" type="text" required>
                                            @error('joining_date')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-12">  
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('emergency_contact_name') is-invalid @enderror" name="emergency_contact_name" value="{{ old('emergency_contact_name') }}" id="emergency_contact_name" type="text"  placeholder="{{ __('Type Contact Name') }}" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('emergency_contact_number') is-invalid @enderror" name="emergency_contact_number" value="{{ old('emergency_contact_number') }}" id="emergency_contact_number" type="text"  placeholder="{{ __('Type Contact Number') }}" >
                                ...
                                <div class="col-sm-6">  
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('emergency_contact_relation') is-invalid @enderror" name="emergency_contact_relation" value="{{ old('emergency_contact_relation') }}" id="emergency_contact_relation" type="text"  placeholder="{{ __('Type Contact Relation') }}" >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <textarea id="emergency_contact_note" class="form-control @error('emergency_contact_note') is-invalid @enderror" name="emergency_contact_note" rows="5">{{ old('emergency_contact_note') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="joining_letter" class="dropify @error('joining_letter') is-invalid @enderror" name="joining_letter" value="{{ old('joining_letter') }}" type="file" 
                                            data-allowed-file-extensions="pdf doc docx" data-max-file-size="250K"/>
                        ...
                        <section>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" type="email"  placeholder="{{ __('Type Email Address') }}" >
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="password"><h4>@lang('Password') <b class="ambitious-crimson">*</b></h4></label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="confirm_password"><h4>@lang('Confirm Password') <b class="ambitious-crimson">*</b></h4></label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-key"></i></span>
                                            </div>
                                            <input class="form-control ambitious-form-loading @error('confirm_password') is-invalid @enderror" name="confirm_password" value="{{ old('confirm_password') }}" id="confirm_password" type="password"  placeholder="{{ __('Type Confirm Password') }}" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('bank_name') is-invalid @enderror" name="bank_name" value="{{ old('bank_name') }}" id="bank_name" type="text"  placeholder="{{ __('Type Bank name') }}" >
                                            @error('bank_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('branch_name') is-invalid @enderror" name="branch_name" value="{{ old('branch_name') }}" id="branch_name" type="text"  placeholder="{{ __('Type Branch Name') }}" >
                                            @error('branch_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('account_name') is-invalid @enderror" name="account_name" value="{{ old('account_name') }}" id="account_name" type="text"  placeholder="{{ __('Type Account Name') }}" >
                                            @error('account_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ambitious-form-loading @error('account_number') is-invalid @enderror" name="account_number" value="{{ old('account_number') }}" id="account_number" type="text" placeholder="{{ __('Type Account NUmber') }}" >
...
@include('script.employee.create.js')
@endsection