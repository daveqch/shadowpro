                                ...
                                @canany(['offline-payment-update', 'offline-payment-delete'])
                                    <td>
                                        @can('offline-payment-update')
                                            <a href="{{ route('offline-payment.edit', $offlinePayment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                        @endcan
                                        @can('offline-payment-delete')
                                            <a href="#" data-href="{{ route('offline-payment.destroy', $offlinePayment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                        @endcan
                                    </td>
                                @endcanany
                            </tr>
