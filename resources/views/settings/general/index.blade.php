                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            @endcan
                                            <a href="{{ route('dashboard') }}" class="btn btn-outline btn-secondary btn-lg float-right">@lang('Cancel')</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <div class="form-group input-group mb-3">
                                                  ...
                                                  @foreach($company->currencies as $value)
                                                       <option value="{{ $value->code }}" @if ($company->default_currency == $value->code) selected="selected" @endif >{{ $value->name }}</option>
                                                   @endforeach
                                                  </select>
                                              </div>
                                            </div>
