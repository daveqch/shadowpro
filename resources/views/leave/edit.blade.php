...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form class="form-material form-horizontal" action="{{ route('leave.update', $leave) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('type') is-invalid @enderror" name="type" value="{{ $leave->type }}" id="type" type="text" required placeholder="{{ __('Type Your Leave Type') }}" >
                                    @error('type')
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="days" class="form-control @error('days') is-invalid @enderror" id="days" required>
                                        <option value="">{{ __('Select Days') }}</option>
                                            @for ($i = 1; $i <= 31; $i++)
                                                <option {{$leave->days===$i?'selected':''}} value="{{$i}}">{{$i}}</option>
                                            @endfor
                                    </select>
                                    @error('days')
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="enabled" id="enabled" class="form-control @error('days') is-invalid @enderror" required>
                                        <option value="">@lang('Select')</option>
                                        <option {{$leave->enabled === 1?'selected':''}} value="1">@lang('Enable')</option>
                                        <option {{$leave->enabled === 0?'selected':''}} value="0">@lang('Disable')</option>
                                    </select>
                                    @error('enabled')
                                        <div class="invalid-feedback">
                                            {{ $message }}
