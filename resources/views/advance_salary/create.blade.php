        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('Create Advance Salary') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>{{ __('New Advance Salary') }}</h3>
            </div>
            <form  class="form-material form-horizontal" action="{{ route('advance-salary.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('reason') is-invalid @enderror" name="reason" value="{{ old('reason') }}" id="reason" type="text"  placeholder="{{ __('Please Type Advance Salary Reason') }}" requred />
                                    @error('reason')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('amount') is-invalid @enderror" value="{{old('amount')}}" name="amount" id="amount" placeholder="{{ __('Type Advance Salary Amount') }}" type="number" min="1" required>
                                    @error('amount')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('date') is-invalid @enderror" value="{{old('date')}}" name="date"  id="date" type="text" autocomplete="off" required>
                                    @error('date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
...
@include('script.advance_salary.create.js')
@endsection