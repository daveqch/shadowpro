        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('Edit Salary') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>{{ __('Edit Salary') }}</h3>
            </div>
            <form id="salaryQuickForm" class="form-material form-horizontal" action="{{ route('salary.update', $salary) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('salary_name') is-invalid @enderror" name="salary_name" value="{{ old('salary_name', $salary->salary_name) }}" id="salary_name" type="text" placeholder="{{ __('Type Your Salary Name Here') }}" required>
                                    @error('salary_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('basic_salary') is-invalid @enderror" name="basic_salary" value="{{ old('basic_salary', $salary->basic_salary) }}" id="basic_salary" type="number" placeholder="{{ __('Type Your Basic Salary Here') }}" required>
                                    @error('basic_salary')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('house_rent') is-invalid @enderror" name="house_rent" value="{{ old('house_rent', $salary->house_rent) }}" id="house_rent" type="number" placeholder="{{ __(' Type Enter House Rent Here') }}">
                                    @error('house_rent')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading" name="house_rent_amount" value="{{ old('house_rent_amount', $salary->house_rent_amount) }}" id="house_rent_amount" type="test" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('medical_allowance') is-invalid @enderror" name="medical_allowance" value="{{ old('medical_allowance', $salary->medical_allowance) }}" id="medical_allowance" type="number" placeholder="{{ __('Type Your Medical Allowance Here') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading" name="medical_allowance_amount" value="{{ old('medical_allowance_amount', $salary->medical_allowance_amount) }}" id="medical_allowance_amount" type="test" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('conveyance_allowance') is-invalid @enderror" name="conveyance_allowance" value="{{ old('conveyance_allowance', $salary->conveyance_allowance) }}" id="conveyance_allowance" type="number" placeholder="{{ __('Type Your Conveyance Allowance Here') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading" name="conveyance_allowance_amount" value="{{ old('conveyance_allowance_amount', $salary->conveyance_allowance_amount) }}" id="conveyance_allowance_amount" type="test" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('food_allowance') is-invalid @enderror" name="food_allowance" value="{{ old('food_allowance', $salary->food_allowance) }}" id="food_allowance" type="number" placeholder="{{ __('Type Your Food Allowance Here') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading" name="food_allowance_amount" value="{{ old('food_allowance_amount', $salary->food_allowance_amount) }}" id="food_allowance_amount" type="test" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('communication_allowance') is-invalid @enderror" name="communication_allowance" value="{{ old('communication_allowance', $salary->communication_allowance) }}" id="communication_allowance" type="number" placeholder="{{ __('Type Your Communication Allowance Here') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading" name="communication_allowance_amount" value="{{ old('communication_allowance_amount', $salary->communication_allowance_amount) }}" id="communication_allowance_amount" type="test" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('other') is-invalid @enderror" name="other" value="{{ old('other', $salary->other) }}" id="other" type="number" placeholder="{{ __('Type Your Other Allowance Here') }}">
                                    @error('other')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading" name="other_amount" value="{{ old('other_amount', $salary->other_amount) }}" id="other_amount" type="test" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var ebasic_salary = Number($('#basic_salary').val());
        var ehouse_rent_number = Number($('#house_rent_amount').val());
        var emedical_allowance = Number($('#medical_allowance_amount').val());
        var econveyance_allowance = Number($('#conveyance_allowance_amount').val());
        var efood_allowance = Number($('#food_allowance_amount').val());
        var ecommunication_allowance = Number($('#communication_allowance_amount').val());
        var eother = Number($('#other_amount').val());
        $("#total_salary").val(ebasic_salary+ehouse_rent_number+emedical_allowance+econveyance_allowance+efood_allowance+ecommunication_allowance+eother);
