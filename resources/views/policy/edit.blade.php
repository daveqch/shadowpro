        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('Edit Policy') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>{{ __('Edit Policy') }}</h3>
            </div>
            <form class="form-material form-horizontal" action="{{ route('policy.update', $policy) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('title') is-invalid @enderror" name="title" value="{{ $policy->title }}" id="title" type="text" required placeholder="{{ __('Type Your Policy Title') }}" >
                                    @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="enabled" id="enabled" class="form-control @error('enabled') is-invalid @enderror" required>
                                        ...
                                        <option {{$policy->enabled=== 1 ?'selected':''}} value="1">@lang('Enable')</option>
                                        <option {{$policy->enabled=== 0 ?'selected':''}} value="0">@lang('Disable')</option>
                                    </select>
                                    @error('enabled')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="col-md-12 px-0">
                            <div class="form-group ">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="description" value="{{ $policy->description }}" id="description">
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
