                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" type="email" placeholder="@lang('Type Customer Email Here')" required>
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('customer.index') }}" class="btn btn-outline btn-secondary btn-lg float-right">@lang('Cancel')</a>
                        </div>
                    </div>
                </div>
            </form>
