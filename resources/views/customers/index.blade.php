                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td>
                                    {{-- <a href="{{ route('customer.show', $customer->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Show')"><span class="mdi mdi-eye ambitious-padding-btn"></span></a>&nbsp;&nbsp; --}}
                                    @can('customer-update')
                                        <a href="{{ route('customer.edit', $customer->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('customer-delete')
                                        <a href="#" data-href="{{ route('customer.destroy', $customer->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
