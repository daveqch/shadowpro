                ...
                <table id="laravel_datatable" class="table table-striped compact table-width">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if(isset($revenue->customer->name) && !empty($revenue->customer->name))
                            ...
                            @canany(['revenue-update', 'revenue-delete'])
                                <td>
                                    @can('revenue-update')
                                        <a href="{{ route('revenue.edit', $revenue) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('revenue-delete')
                                        <a href="#" data-href="{{ route('revenue.destroy', $revenue) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                    @endcan
                                </td>
                            @endcanany
                        </tr>
