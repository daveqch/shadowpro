            ...
            <div class="card-body">
                ...
                <table id="laravel_datatable" class="table table-striped compact table-width">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img class="profile-user-img img-fluid img-circle" src="{{ asset($item->picture) }}" alt="" /></td>
                            <td>{{ $item->name }}</td>
                            ...
                            @canany(['item-update', 'item-delete'])
                                <td>
                                    @can('item-update')
                                        <a href="{{ route('item.edit', $item) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('item-delete')
                                        <a href="#" data-href="{{ route('item.destroy', $item) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                    @endcan
                                </td>
                            @endcanany
                        </tr>
