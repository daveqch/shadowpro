                ...
                <table id="laravel_datatable" class="table table-striped compact table-width">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bill.show', $bill) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="View"><span class="mdi mdi-eye ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                @can('revenue-update')
                                    <a href="{{ route('bill.edit', $bill) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                @endcan
                                @can('revenue-delete')
                                    <a href="#" data-href="{{ route('bill.destroy', $bill) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                @endcan
                            </td>
                        </tr>
                        @endforeach
