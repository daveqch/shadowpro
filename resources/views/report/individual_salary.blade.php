    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>{{ __('Individul Salary') }}</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('salary.actionIndividualSalary') }}" method="post">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input target="_blank" id="submit_attendance" type="submit" class="form-control btn btn-outline btn-info"/>
                        </div>
                    </div>
                </form>
            </div>
...
@include('script.salary_individual.js')
@endsection
