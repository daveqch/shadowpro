...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form class="form-material form-horizontal" action="{{ route('appsetting.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('dashboard') }}" class="btn btn-secondary btn-lg float-right">@lang('Cancel')</a>
                </div>
            </form>
        </div>
    </div>
