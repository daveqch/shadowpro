                ...
                <tbody>
                    @foreach ($lists as $list)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('smtp.edit', $list) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                <a href="#" data-href="{{ route('smtp.destroy', $list) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
