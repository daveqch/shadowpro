                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                @canany(['category-update', 'category-delete'])
                                    <td>
                                        @can('category-update')
                                            <a href="{{ route('category.edit', $category) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="Edit"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                        @endcan
                                        @can('category-delete')
                                            <a href="#" data-href="{{ route('category.destroy', $category) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                        @endcan
                                    </td>
                                @endcanany
                            </tr>
