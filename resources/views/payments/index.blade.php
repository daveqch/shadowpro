                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @canany(['payment-update', 'payment-delete'])
                                <td>
                                    @can('payment-update')
                                        <a href="{{ route('payment.edit', $payment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('payment-delete')
                                        <a href="#" data-href="{{ route('payment.destroy', $payment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                    @endcan
                                </td>
                            @endcanany
                        </tr>
