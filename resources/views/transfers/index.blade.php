                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @canany(['transfer-update', 'transfer-delete'])
                                <td>
                                    @can('transfer-update')
                                        <a href="{{ route('transfer.edit', $transfer) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><span class="mdi mdi-pencil ambitious-padding-btn"></span></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('transfer-delete')
                                        <a href="#" data-href="{{ route('transfer.destroy', $transfer) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><span class="mdi mdi-delete ambitious-padding-btn"></span></a>
                                    @endcan
                                </td>
                            @endcanany
                        </tr>
